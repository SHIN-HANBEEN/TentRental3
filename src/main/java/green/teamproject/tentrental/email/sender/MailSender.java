package green.teamproject.tentrental.email.sender;
...
public class MailSender {
    ...
    String senderPassword = "tlsdpqls825"; //메일을 발송하는 이메일 계정 비밀번호
    ...
    public MailSender(String name, String subject, String text) {
        this.name = name;
